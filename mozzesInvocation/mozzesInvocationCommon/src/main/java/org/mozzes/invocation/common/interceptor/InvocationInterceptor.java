...
public interface InvocationInterceptor {
   ...
   * 
   * @param <I>
   *          Interface intercepted by this interceptor
   * @param invocation
   *          Method invocation
   * @param target
   *          Invocation handler which will handle method invocation
   * @return Invocation result
   * @throws Throwable
   *           any exception thrown during invocation handling or intercept
   */
  public <I> Object invoke(Invocation<? super I> invocation, InvocationHandler<I> target) throws Throwable;
