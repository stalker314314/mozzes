...
public class NettyRemotingServer extends RemotingServer {
	...
	/**
	 * All clients connected to the server are contained inhere. So, when someone stop server,
	...
	public synchronized void startServer() {
		...
		executionHandler = new ExecutionHandler(new OrderedMemoryAwareThreadPoolExecutor(nettyServerConfiguration.getWorkers(), 
				nettyServerConfiguration.getMemoryPerChannel(), nettyServerConfiguration.getMemoryPerPool()));
