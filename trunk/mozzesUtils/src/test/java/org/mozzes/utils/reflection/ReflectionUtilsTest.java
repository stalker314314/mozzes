...
public class ReflectionUtilsTest {
  ...
  public void testGetSetter() {
    ...
    // Test has setter
    assertNotNull(ReflectionUtils.getSetter(ClassForTesting.class, Integer.class, "write"));

    // Test has setter boolean (napomena: boolean!=Boolean)
    assertNotNull(ReflectionUtils.getSetter(ClassForTesting.class, boolean.class, "readWriteB"));
    ...
    assertNotNull(ReflectionUtils.getSetter(ClassForTesting.class, Integer.class, "readWriteP"));
  ...
  public void testGetGetter() {
    ...
    try {
      ReflectiveMethod<ClassForTesting, Integer> getter = ReflectionUtils.getGetter(ClassForTesting.class,
          Integer.class, "read");
    ...
    try {
      ReflectiveMethod<ClassForTesting, Boolean> getter = ReflectionUtils.getGetter(ClassForTesting.class,
          Boolean.class, "readWriteB");
      assertNotNull(getter);
    } catch (NoSuchMethodException e) {
      fail("Should not happen!");
    }
    ...
    try {
      ReflectiveMethod<ClassForTesting, Integer> getter = ReflectionUtils.getGetter(ClassForTesting.class, int.class,
          "readWriteP");
      assertNotNull(getter);
    } catch (NoSuchMethodException e) {
      fail("Should not happen!");
