...
public abstract class ApplicationModule {
  ...
  /**
   * @return the service interceptors that this module provides. Interceptors included here are invoked only for service
   *         call defined in this module (see {@link #getServices()}).
   */
