...
/**
 * Server pipeline factory used to create server business logic for processing clients
 * requests. 
 * 
...
public class MozzesServerPipelineFactory implements ChannelPipelineFactory {
	 ...
	 * @param executionHandler - executes channel events without blocking I/O worker threads
	 */
