...
public class FutureAction implements Callable<Object> {
	...
	/**
	 * Creates future action. This action is as soon as possible submitted for execution.
	 * After submitting special worker thread will hold on for receiving response.   
	...
	/**
	 * Set the response received from the server. After receiving this response client who waited for it
	 * is waken.
