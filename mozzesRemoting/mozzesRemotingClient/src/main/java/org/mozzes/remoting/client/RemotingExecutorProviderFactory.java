...
public class RemotingExecutorProviderFactory {
	...
	private ConcurrentMap<RemotingConfiguration, RemotingActionExecutorProvider> pools =
		new ConcurrentHashMap<RemotingConfiguration, RemotingActionExecutorProvider>();
	 ...
	 * Default constructor
	 * 
	 * @param clientFactory Client factory with which this executor should be created
	 */
	...
	/**
	 * Adds new configuration to factory that will return on-demand providers. On-demand providers should be used
	 * when very small number of actions is going to be executed on remoting server If identical configuration
